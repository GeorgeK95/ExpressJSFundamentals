...
const headerHandler = require(webConstants.HEADER_HANDLER_PATH);
...
module.exports = [headerHandler, contentFilesHandler, homeHandler, addMovieHandler, viewAllMoviesHandler, movieDetailsHandler];